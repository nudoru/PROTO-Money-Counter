...
- (void)pushViewController:(UIViewController *)viewController withCustomTransition:(CustomViewAnimationTransition)transition subtype:(NSString*)subtype {
    switch (transition) {
        ...
        case CustomViewAnimationTransitionFlipFromRight:{
            ...
            break;}
        case CustomViewAnimationTransitionFlipFromTop:{
            [self standardAnimationWithController:viewController duration:.5 options:UIViewAnimationOptionTransitionFlipFromTop
									 changesBlock:^{
										 [self pushViewController:viewController animated:NO];
									 }];
            break;}
		case CustomViewAnimationTransitionFlipFromBottom:{
            [self standardAnimationWithController:viewController duration:.5 options:UIViewAnimationOptionTransitionFlipFromBottom
									 changesBlock:^{
										 [self pushViewController:viewController animated:NO];
									 }];
            break;}
...
- (void)popViewControllerWithCustomTransition:(CustomViewAnimationTransition)transition subtype:(NSString*)subtype {
    switch (transition) {
		...
		case CustomViewAnimationTransitionFlipFromTop:{
            [self standardAnimationWithController:nil duration:.5 options:UIViewAnimationOptionTransitionFlipFromTop
                                     changesBlock:^{
                                         [self popViewControllerAnimated:NO];
                                     }];
            break;}
		case CustomViewAnimationTransitionFlipFromBottom:{
            [self standardAnimationWithController:nil duration:.5 options:UIViewAnimationOptionTransitionFlipFromBottom
                                     changesBlock:^{
                                         [self popViewControllerAnimated:NO];
                                     }];
            break;}
