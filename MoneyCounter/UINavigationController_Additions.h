...
// http://stackoverflow.com/questions/9480458/change-animation-transition
...
typedef enum {
	...
	CustomViewAnimationTransitionFlipFromTop,
    CustomViewAnimationTransitionFlipFromBottom,
